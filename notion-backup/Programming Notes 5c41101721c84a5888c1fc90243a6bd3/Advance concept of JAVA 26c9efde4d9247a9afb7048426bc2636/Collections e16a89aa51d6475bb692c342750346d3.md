...
- Initial Capacity(if initial capacity 10 so the maximum capcity is 10)
- Load Factor( “it is defined as the number of elements actually present in the hasset upon the total number of elements the hassetcan hold currently”.)
